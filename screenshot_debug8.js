...
(async () => {
  ...
  try {
    ...
    if (fileDivs.length > 0) {
      ...
      await page.locator('button[title="Hide Selected Elements"]').click();
      await page.waitForTimeout(500);
    }

    await page.screenshot({ path: 'debug_graph8.png' });
    console.log('Screenshot saved to debug_graph8.png');
  } catch (e) {
